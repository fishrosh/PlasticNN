...
${OBJECTDIR}/src/DumbedDownNeuralNet.o: src/DumbedDownNeuralNet.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DumbedDownNeuralNet.o src/DumbedDownNeuralNet.cpp

${OBJECTDIR}/src/FileLoader.o: src/FileLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileLoader.o src/FileLoader.cpp
...
${OBJECTDIR}/src/MNIST.o: src/MNIST.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MNIST.o src/MNIST.cpp

${OBJECTDIR}/src/NeuralNet.o: src/NeuralNet.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/NeuralNet.o src/NeuralNet.cpp

${OBJECTDIR}/src/Randomize.o: src/Randomize.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Randomize.o src/Randomize.cpp

${OBJECTDIR}/src/SmartMatrix.o: src/SmartMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SmartMatrix.o src/SmartMatrix.cpp
